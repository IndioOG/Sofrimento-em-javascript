...
// let palpite = +prompt('digite um numero para ganhar um bingo');

// do {

//   alert(palpite);
 
//   palpite = +prompt('numero errado tente novamente');
...
// lista com nomes
//const listaDeNomes = ['traviscott1', 'virginia', 'anacastela', 'neymaru', 'viniJr'];
//chamo a POSIÇÃO 2 da lista (lista inicia em 0)
//console.log(listaDeNomes[0])

// const frutas = ['maça', 'maracuja', 'uva', 'pessego', 'acerola', 'morando', 'caja', 'banana'];
// console.log(frutas);
...
//   contador++
// }
// const listaDeCantores = ['traviscott', 'nopdog', 'keanye', 'brandao', 'joelma', 'zimbra', 'gloriagroove', ]
// listaDeCantores.forEach((item) => {
//   console.log(item)
// })
...
//   if (tipo == 'retangulo') {
//     console.log('area: ',  valor1 * valor2, 'perimetro: ', (2 * (valor1 + valor2)))
//   }
// }
// calcularAreaPerimetro('retangulo', 4, 5);
...
//   }
//   else if(quantidade <= limiteBaixo) {
//     console.log('Atenção: Estoque Baixo');
//   }
// }
// verificarEstoque(8, 10);
